 ...
 * 根据路径生成面包屑
 */
export function getBreadcrumbs(routes: AppRouteObject[], pathname: string): Breadcrumb[] {
  const breadcrumbs: Breadcrumb[] = []

  function findRoute(routes: AppRouteObject[], pathname: string, parentPath = ''): Breadcrumb[] {
