...
const config: Config = {
  ...
  collectCoverageFrom: ['src/api/**/*.ts', '!src/api/**/*.d.ts'],
  coverageThreshold: {
    global: {
      branches: 80,
      functions: 80,
 ...
 * PUT 请求
 */
export async function put(url: string, body: any, options: RequestOptions = {}): Promise<Response> {
