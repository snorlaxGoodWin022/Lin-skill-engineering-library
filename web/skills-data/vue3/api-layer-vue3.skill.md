 ...
 * 获取用户列表
 */
export async function fetchUserList(params: UserListParams): Promise<PaginatedResponse<User>> {
...
export function useUserDetail(
  ...
  options?: Omit<UseQueryOptions<User, Error, User>, 'queryKey' | 'queryFn' | 'enabled'>
) {
...
import { ElMessage } from 'element-plus'
import { createUser, updateUser, deleteUser, batchDeleteUsers, updateUserStatus } from '@/api/user'
...
export function useCreateUser(
  options?: Omit<UseMutationOptions<User, Error, CreateUserParams>, 'mutationFn'>
) {
...
export function useUpdateUser(
  ...
  const mutation = useMutation({
    mutationFn: ({ id, data }: { id: string; data: UpdateUserParams }) => updateUser(id, data),
...
<template>
  <div class="user-list">
    ...
    <!-- 表格 -->
    <el-table v-loading="isLoading" :data="list" @selection-change="handleSelectionChange">
