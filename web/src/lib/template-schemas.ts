  ...
  crud: {
    ...
    fields: [
      ...
      },
      {
        ...
        label: '附加功能',
        type: 'textarea',
        placeholder: '如：批量删除, 导出, 状态切换（逗号分隔）',
      },
    ],
  },
  ...
  'unit-test': {
    ...
    fields: [
      ...
      },
      {
        ...
        label: '需要测试的场景',
        type: 'textarea',
        placeholder: '如：正常提交, 空表单验证, 网络错误（每行一个）',
      },
    ],
  },
